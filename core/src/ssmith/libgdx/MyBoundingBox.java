...
/**
 * This is a copy of LibGDDX's BoundingBox, but cnt can be set.
 * @author StephenCS
 *
 */
public class MyBoundingBox implements Serializable {
	 ...
	 * @return This bounding box for chaining. */
	public MyBoundingBox ext (MyBoundingBox a_bounds) {
	 ...
	 * @return This bounding box for chaining. */
	public MyBoundingBox ext (Vector3 center, float radius) {
