...
public class WireframeShader extends DefaultShader {
    ...
    private void restorePrimitiveType(Renderable renderable) {
    	renderable.meshPart.primitiveType = mSavedPrimitiveType; // gdxVersion = '1.6.4'
    ...
    private void setPrimitiveType(Renderable renderable) {
        mSavedPrimitiveType = renderable.meshPart.primitiveType; //gdxVersion = '1.6.4'
        renderable.meshPart.primitiveType = PRIMITIVE_TYPE; //gdxVersion = '1.6.4'
