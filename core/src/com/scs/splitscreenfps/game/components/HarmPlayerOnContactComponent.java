...
public class HarmPlayerOnContactComponent {
	...
	public HarmPlayerOnContactComponent(AbstractEntity _shooter, Vector3 _start_pos, String _sfx, int _damage, float _dropoff_per_metre, boolean _remove, boolean _show_explosion) {
		shooter = _shooter;
		if (_start_pos != null) {
